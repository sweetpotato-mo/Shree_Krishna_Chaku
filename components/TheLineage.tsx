            ...
            <div className="space-y-4 text-lg text-masi-black leading-relaxed">
              ...
              <p>
                ...
                <span className="lang-ne">
                  ...
                  {" "}को गर्विलो सदस्यका रूपमा हामी यस ऐतिहासिक परम्पराको शुद्धता र मौलिकता कायम राख्न प्रतिबद्ध छौं। हाम्रो चाकु SO<sub>2</sub> (सल्फर) मुक्त छ र कुनै अतिरिक्त रङ्ग वा संरक्षक तत्वहरू मिसाइएको छैन—यो केवल शुद्ध र परम्परागत हस्तकलाको उपज हो।
                </span>
              </p>
            </div>
