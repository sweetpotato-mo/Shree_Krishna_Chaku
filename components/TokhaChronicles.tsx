...
const chronicles: Chronicle[] = [
  {
    ...
    titleNe: "किलाको गोप्य ताल",
    excerpt:
      "In the quiet hours of dawn, the KILA—the stout wooden hook secured into the wall—becomes a metronome of tradition. Each pull (Taneko), each stretch, follows a rhythm passed down through generations—a rhythm that cannot be rushed.",
    excerptNe:
      "बिहानको शान्त घण्टाहरूमा, किला—काठको मोटो हुक जुन भित्तामा सुरक्षित गरिएको हुन्छ—परम्पराको मेट्रोनोम बन्छ। प्रत्येक तान्ने, प्रत्येक फैलाउने, पुस्ता दर पुस्ता हस्तान्तरित ताल अनुसरण गर्छ—एक ताल जुन हतार गर्न सकिँदैन।",
  ...
  },
  {
    ...
    excerptNe:
      "माघे सङ्क्रान्तिले टोखामा चाकुको मौसमको चरमोत्कर्षलाई जनाउँछ। चिसो जाडोको हावा, आगोको तातो, र सँगै चाकु बनाउने सामुदायिक भावना यो टोखा साँच्चै जीवन्त हुने समय हो।",
    date: "Maghe Sankranti 2080 B.S.",
    category: "Festival",
  },
  {
    ...
    excerptNe:
      "हजुरबाबाबाट बाबामा, बाबाबाट छोरामा, र अब अर्को पुस्तामा प्रत्येकले आफ्नो स्पर्श थपेका छन्, सँगसँगै हाम्रो चाकुलाई विशेष बनाउने मुख्य सार संरक्षण गर्दै।",
  ...
  },
  {
    ...
    excerptNe:
      "तत्काल संतुष्टिको संसारमा, चाकुले हामीलाई धैर्यको मूल्य सिकाउँछ। घण्टौंको बिस्तारै तान्ने, तापक्रममा सावधानी, र प्रक्रियाप्रति सम्मान, यी पाठहरू भान्छाबाट टाढा फैलिन्छन्।",
...
const TokhaChronicles: React.FC = () => {
  ...
  const handleReadMore = (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    const archiveSection = document.getElementById("smarika-archive");
    if (archiveSection) {
    ...
    <section id="chronicles" className="relative py-24 md:py-32 bg-parchment">
          ...
          <div className="bg-masi-black text-parchment p-4 md:p-6 rounded-lg shadow-2xl border-2 border-hyangu-red max-w-sm">
            <div className="flex items-start justify-between gap-4">
              <p className="text-sm md:text-base leading-relaxed flex-1">
                The full article and digital records for this chapter will be
                available here soon.
              </p>
              <button
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 md:mt-20">
          <article
            id="smarika-archive"
            className="relative bg-[#F9F6F0] border-4 border-masi-black p-8 md:p-12 max-w-3xl mx-auto"
